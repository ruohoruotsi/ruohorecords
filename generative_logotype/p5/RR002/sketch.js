...
let url = "https://coolors.co/fbba72-ca5310-bb4d00-dc851f-78290f" // aight
...
function setup() {
  ...
  for (let i = 0; i < width * height * 25 / 100; i++) {
    ...
    // random(100) > 50 ? graphics.fill(0, 0, 100, 25) : graphics.fill(0, 0, 0, 35);  // HSBmode
    graphics.fill(80, 33, 7, 45); // good brown, better than mixing orange and brown
...
function draw() {
  ...
  textSize(60);
  text("A-G V.2", (canvasSize_w - middleSize)/2 + 15, 0, middleSize, 100);
